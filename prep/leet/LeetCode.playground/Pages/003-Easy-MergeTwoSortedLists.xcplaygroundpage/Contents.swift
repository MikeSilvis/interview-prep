...
check("Test 1", linkedListToArray(solution.mergeTwoLists(createLinkedList([1, 2, 4]), createLinkedList([1, 3, 4]))), [1, 1, 2, 3, 4, 4])
check("Test 2", linkedListToArray(solution.mergeTwoLists(nil, nil)), [])
check("Test 3", linkedListToArray(solution.mergeTwoLists(nil, createLinkedList([0]))), [0])
