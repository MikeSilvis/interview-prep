...
lruCache.put(1, 1)
lruCache.put(2, 2)
check("get(1) after put(1,1) put(2,2)", lruCache.get(1), 1)
lruCache.put(3, 3) // Evicts key 2
check("get(2) after eviction", lruCache.get(2), -1)
lruCache.put(4, 4) // Evicts key 1
check("get(1) after eviction", lruCache.get(1), -1)
check("get(3)", lruCache.get(3), 3)
check("get(4)", lruCache.get(4), 4)

/*
 Follow-up Questions:
 1. How does the doubly linked list + hash map achieve O(1) for both operations?
 2. What is the difference between LRU and LFU cache?
